        ...
        do{
            try {
                ...
                switch (opcion) {
                    ...
                    case 4:
                        if (!pila.PilaVacia()) {
                            JOptionPane.showMessageDialog(null, "El último valor ingresado en la pila es: "+pila.MostrarUltimoValorIngresado());
                        }
                        else{
                            JOptionPane.showMessageDialog(null, "La pila esta vacia");
                        }
                    ...
                    default:
                        JOptionPane.showMessageDialog(null, "Opción incorrecta, vuelve ha intentar nuevamente.");
                        break;
