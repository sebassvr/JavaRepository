...
public class VentanaDivisas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuDivisas = new javax.swing.JMenuBar();
        ...
        botonBorrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenesProyectoCalculadora/iconSalir.png"))); // NOI18N
        ...
        menuDivisas.add(jMenu1);

        setJMenuBar(menuDivisas);
    ...
    private void comboDivisas1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboDivisas1ActionPerformed
        divisas1 = (String) comboDivisas1.getSelectedItem();
        if (divisas1.equals("Estados Unidos - Dólar")) {
            etiquetaDivisa1.setText("$");
        }
        else if (divisas1.equals("Perú - Nuevo Sol")) {
    ...
    private void comboDivisas2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboDivisas2ActionPerformed
        divisas2 = (String) comboDivisas2.getSelectedItem();
        if (divisas2.equals("Estados Unidos - Dólar")) {
            etiquetaDivisa2.setText("$");
        }
        else if (divisas2.equals("Perú - Nuevo Sol")) {
    ...
    private void cambioDivisas(){
        if (divisas1.equals(divisas2)) {
            cambio = 1;
        }
        else if (divisas1.equals("Estados Unidos - Dólar") && divisas2.equals("Perú - Nuevo Sol")) {
            cambio = 3.68;
        }
        else if (divisas1.equals("Estados Unidos - Dólar") && divisas2.equals("Europa - Euro")) {
            cambio = 0.91;
        }
        else if (divisas1.equals("Perú - Nuevo Sol") && divisas2.equals("Estados Unidos - Dólar")) {
            cambio = 0.27;
        }
        else if (divisas1.equals("Perú - Nuevo Sol") && divisas2.equals("Europa - Euro")) {
            cambio = 0.25;
        }
        else if (divisas1.equals("Europa - Euro") && divisas2.equals("Estados Unidos - Dólar")) {
            cambio = 1.10;
        }
        else if (divisas1.equals("Europa - Euro") && divisas2.equals("Perú - Nuevo Sol")) {
            cambio = 4.03;
        }
    }
    ...
    private javax.swing.JMenuBar menuDivisas;
